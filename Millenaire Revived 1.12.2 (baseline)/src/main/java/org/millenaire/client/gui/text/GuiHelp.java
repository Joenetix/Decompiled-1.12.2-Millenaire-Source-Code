   ...
   protected void customDrawBackground(int mouseX, int mouseY, float f) {
      ...
      for (int i = 0; i < 7; i++) {
         if (this.helpDisplayed - 1 != i) {
            ...
            this.drawGradientRect(xStart, yStart - extraFirstRow + 32 * i + 1, xStart + 32, yStart + 32 * i + 32, -1610612736, -1610612736);
         }

         if (this.helpDisplayed - 8 != i) {
            int extraFirstRow = i == 0 ? 1 : 0;
            this.drawGradientRect(xStart + 224, yStart - extraFirstRow + 32 * i + 1, xStart + 32 + 224, yStart + 32 * i + 32, -1610612736, -1610612736);
         }
      }
   ...
   protected void customDrawScreen(int mouseX, int mouseY, float f) {
      ...
      if (mouseX > 0 && mouseX < 32) {
         ...
         if (pos >= 0 && pos < 13) {
            ...
            this.drawGradientRect(mouseX + 10 - 3, mouseY + 10 - 3, mouseX + 10 + stringlength + 3, mouseY + 10 + 14, -1073741824, -1073741824);
