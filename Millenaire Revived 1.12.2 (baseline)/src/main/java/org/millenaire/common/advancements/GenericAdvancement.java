...
public class GenericAdvancement implements ICriterionTrigger<AlwaysTrueCriterionInstance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, Listener<AlwaysTrueCriterionInstance> listener) {
   ...
   public void removeListener(PlayerAdvancements playerAdvancementsIn, Listener<AlwaysTrueCriterionInstance> listener) {
      PlayerListeners listeners = this.playerListeners.get(playerAdvancementsIn);
      if (listeners != null) {
