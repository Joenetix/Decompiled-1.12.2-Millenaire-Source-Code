...
public class ItemSummoningWand extends ItemMill {
   ...
   public EnumActionResult onItemUseFirst(EntityPlayer player, World world, BlockPos bp, EnumFacing side, float hitX,
      ...
      if (targetBlock == MillBlocks.IMPORT_TABLE) {
         ...
         System.out.println("Millenaire DEBUG: Summoning Wand used at " + pos);
