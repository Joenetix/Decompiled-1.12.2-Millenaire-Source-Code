...
public class BuildingDevUtilities {
   ...
   public static void generateWikiTable() throws MillLog.MillenaireException {
      ...
      picts.put(InvItem.createInvItem(Blocks.TALLGRASS, 1), "TallGrass.png");
      picts.put(InvItem.createInvItem(Blocks.TALLGRASS, 2), "Fern.png");
      ...
      picts.put(InvItem.createInvItem(Blocks.FLOWING_LAVA, 0), "Lava.png");
   ...
   public static void writePlanCostTextStyle(BuildingPlanSet set, BufferedWriter writer) throws IOException {
      ...
      for (BuildingPlan[] plans : set.plans) {
         ...
         for (InvItem keyx : totalCost.keySet()) {
            writer.write(keyx.getName() + "(" + keyx.item.getRegistryName() + "/" + keyx.meta + "): " + totalCost.get(keyx) + "\n");
         }
         ...
         for (BuildingPlan plan : plans) {
            ...
            for (InvItem keyx : plan.resCost.keySet()) {
               writer.write(keyx.getName() + "(" + keyx.item.getRegistryName() + "/" + keyx.meta + "): " + plan.resCost.get(keyx) + "\n");
            }
         }
      }
