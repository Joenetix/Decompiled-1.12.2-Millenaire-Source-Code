...
public class TileEntityPanel extends TileEntity {
   ...
   public void readFromNBT(NBTTagCompound compound) {
      ...
      while (compound.hasKey("Lines_" + pos)) {
         this.untranslatedLines.add(TileEntityPanel.PanelUntranslatedLine.readFromNBT(compound.getCompoundTag("Lines_" + pos)));
         pos++;
      }
   }
   ...
   public NBTTagCompound writeToNBT(NBTTagCompound compound) {
      ...
      try {
         ...
         for (int i = 0; i < this.untranslatedLines.size(); i++) {
            compound.setTag("Lines_" + i, this.untranslatedLines.get(i).writeToNBT(new NBTTagCompound()));
         }
   ...
   public static class PanelUntranslatedLine {
      ...
      public static TileEntityPanel.PanelUntranslatedLine readFromNBT(NBTTagCompound compound) {
      ...
      private static String[] readText(NBTTagCompound compound, String key) {
         ...
         for (int i = 0; compound.hasKey(key + "_" + i); i++) {
      ...
      public NBTTagCompound writeToNBT(NBTTagCompound compound) {
         ...
         compound.setTag("leftIcon", this.leftIcon.writeToNBT(new NBTTagCompound()));
         compound.setTag("middleIcon", this.middleIcon.writeToNBT(new NBTTagCompound()));
         compound.setTag("rightIcon", this.rightIcon.writeToNBT(new NBTTagCompound()));
