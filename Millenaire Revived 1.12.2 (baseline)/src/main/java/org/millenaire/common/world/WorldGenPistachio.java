...
public class WorldGenPistachio extends WorldGenAbstractTree {
   ...
   private final IBlockState metaWood = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, EnumType.OAK);
   private final IBlockState metaLeaves = MillBlocks.LEAVES_PISTACHIO.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
