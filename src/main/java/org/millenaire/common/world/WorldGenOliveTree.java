...
public class WorldGenOliveTree extends WorldGenAbstractTree {
   ...
   private static final IBlockState WOOD_BS = Blocks.LOG2.getDefaultState().withProperty(BlockNewLog.VARIANT, EnumType.ACACIA);
   private static final IBlockState LEAVES_BS = MillBlocks.LEAVES_OLIVETREE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
