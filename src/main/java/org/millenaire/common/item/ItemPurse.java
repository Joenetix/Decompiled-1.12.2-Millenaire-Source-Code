...
public class ItemPurse extends ItemMill {
   ...
   private void storeDeniersInPurse(ItemStack purse, EntityPlayer player) {
      int deniers = WorldUtilities.getItemsFromChest(player.inventory, MillItems.DENIER, 0, Integer.MAX_VALUE);
      int deniersargent = WorldUtilities.getItemsFromChest(player.inventory, MillItems.DENIER_ARGENT, 0, Integer.MAX_VALUE);
      int deniersor = WorldUtilities.getItemsFromChest(player.inventory, MillItems.DENIER_OR, 0, Integer.MAX_VALUE);
