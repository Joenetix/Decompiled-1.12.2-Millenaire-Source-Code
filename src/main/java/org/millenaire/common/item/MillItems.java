...
public class MillItems {
   ...
   static ToolMaterial better_steel = EnumHelper.addToolMaterial("bettersteel", 2, 1561, 5.0F, 3.0F, 10);
   static ToolMaterial TOOLS_byzantine = EnumHelper.addToolMaterial("byzantineTools", 2, 1561, 12.0F, 3.0F, 15);
   ...
   static ArmorMaterial ARMOUR_norman = EnumHelper.addArmorMaterial(
      "normanArmour", "millenaire:norman", 66, new int[]{3, 8, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F
   );
   static ArmorMaterial ARMOUR_japanese_red = EnumHelper.addArmorMaterial(
      "japanese", "millenaire:japanese_red", 33, new int[]{2, 6, 5, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F
   );
   static ArmorMaterial ARMOUR_japanese_blue = EnumHelper.addArmorMaterial(
      "japanese", "millenaire:japanese_blue", 33, new int[]{2, 6, 5, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F
   );
   static ArmorMaterial ARMOUR_japaneseGuard = EnumHelper.addArmorMaterial(
      "japaneseGuard", "millenaire:japanese_guard", 25, new int[]{2, 5, 4, 1}, 25, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F
   );
   static ArmorMaterial ARMOUR_byzantine = EnumHelper.addArmorMaterial(
      "byzantineArmour", "millenaire:byzantine", 33, new int[]{3, 8, 6, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F
   );
   static ArmorMaterial ARMOUR_mayan_quest_crown = EnumHelper.addArmorMaterial(
      "mayanQuestCrown", "millenaire:mayan_quest_crown", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F
   );
   static ArmorMaterial ARMOUR_SELJUK = EnumHelper.addArmorMaterial(
      "seljukArmour", "millenaire:seljuk", 66, new int[]{3, 8, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F
   );
   static ArmorMaterial ARMOUR_SELJUK_WOOL = EnumHelper.addArmorMaterial(
      "seljukWoolArmour", "millenaire:seljuk_wool", 7, new int[]{2, 5, 3, 1}, 10, SoundEvents.BLOCK_CLOTH_PLACE, 0.0F
   );
   static ArmorMaterial ARMOUR_fur = EnumHelper.addArmorMaterial("fur", "millenaire:furcoat", 7, new int[]{2, 5, 3, 1}, 25, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F);
   ...
   public static void registerItemModels() {
      try {
         ...
         MillLog.printException("Error, illegal argument, while initialising item models", var6);
      } catch (IllegalAccessException var7) {
         MillLog.printException("Error, illegal access, while initialising item models", var7);
      }
   ...
   public static void registerItems(Register<Item> event) {
      ...
      event.getRegistry().register(new ItemMillSeeds(MillBlocks.CROP_RICE, "rice"));
      event.getRegistry().register(new ItemMillSeeds(MillBlocks.CROP_TURMERIC, "turmeric"));
      event.getRegistry().register(new ItemMillSeeds(MillBlocks.CROP_MAIZE, "maize"));
      event.getRegistry().register(new ItemMillSeeds(MillBlocks.CROP_VINE, "grapes"));
      event.getRegistry().register(new ItemMillSeeds(MillBlocks.CROP_COTTON, "cotton"));
      ...
      event.getRegistry().register(new ItemMillenaireSword("mayanmace", ToolMaterial.IRON, -1, false).setFull3D());
      event.getRegistry().register(new ItemMillenaireSword("tachisword", TOOLS_obsidian, -1, false).setFull3D());
      event.getRegistry().register(new ItemMillenaireSword("byzantinemace", ToolMaterial.IRON, -1, true).setFull3D());
      event.getRegistry().register(new ItemMillenaireSword("inuittrident", ToolMaterial.IRON, 20, false).setFull3D());
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("rasgulla", 2, 30, 0, 0.0F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.SPEED, 9600, 1), 1.0F)
               .setAlwaysEdible()
               .setMaxStackSize(64)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("balche", 6, 20, 0, 0.0F, true, 7)
               .setPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 9600, 1), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(512)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("cacauhaa", 6, 30, 0, 0.0F, true, 0)
               .setPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 9600, 1), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(384)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("sake", 8, 30, 0, 0.0F, true, 10)
               .setPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 9600, 1), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(512)
         );
      event.getRegistry()
         .register(
            new ItemFoodMultiple("ikayaki", 0, 0, 10, 1.0F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING, 9600, 2), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(512)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("souvlaki", 0, 0, 10, 1.0F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.INSTANT_HEALTH, 1, 2), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(512)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("winefancy", 8, 30, 0, 0.0F, true, 5)
               .setPotionEffect(new PotionEffect(MobEffects.RESISTANCE, 9600, 2), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(1024)
         );
      event.getRegistry()
         .register(
            new ItemFoodMultiple("bearmeat_raw", 0, 0, 4, 0.5F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.STRENGTH, 4800, 1), 1.0F)
               .setAlwaysEdible()
               .setMaxStackSize(64)
         );
      event.getRegistry()
         .register(
            new ItemFoodMultiple("bearmeat_cooked", 0, 0, 10, 1.0F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.STRENGTH, 9600, 2), 1.0F)
               .setAlwaysEdible()
               .setMaxStackSize(64)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("wolfmeat_cooked", 0, 0, 5, 0.6F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.STRENGTH, 1200, 1), 1.0F)
               .setAlwaysEdible()
               .setMaxStackSize(64)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("seafood_cooked", 0, 0, 2, 0.25F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING, 1200, 1), 1.0F)
               .setAlwaysEdible()
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("inuitbearstew", 0, 0, 8, 1.0F, false, 0)
               .setPotionEffect(new PotionEffect(MobEffects.STRENGTH, 9600, 3), 1.0F)
               .setAlwaysEdible()
               .setMaxDamage(512)
         );
      ...
      event.getRegistry()
         .register(
            new ItemFoodMultiple("lokum", 0, 0, 3, 0.0F, false, 0).setPotionEffect(new PotionEffect(MobEffects.SPEED, 2400, 1), 0.2F).setAlwaysEdible()
         );
      event.getRegistry()
         .register(
            new ItemFoodMultiple("helva", 0, 0, 5, 0.0F, false, 0).setPotionEffect(new PotionEffect(MobEffects.RESISTANCE, 2400, 1), 0.2F).setAlwaysEdible()
         );
      ...
      event.getRegistry().register(new ItemParchment("parchment_japanesefull", new int[]{16, 17, 18}, true));
