      ...
      if (params.length != 5 && params.length != 8) {
         ...
         if (rgb.length != 3) {
            ...
            if (param_cost_itemorblock != null) {
               ...
               if (quantity == 0) {
               ...
               } else if (Block.getBlockFromName(param_cost_itemorblock) != null
                  && Item.getItemFromBlock(Block.getBlockFromName(param_cost_itemorblock)) != Items.AIR) {
                  ...
                  if (Item.getByNameOrId(param_cost_itemorblock) == null) {
