...
public class GoalGenericCrafting extends GoalGeneric {
    ...
    public Goal.GoalInformation getDestination(MillVillager villager) throws Exception {
        for (Building dest : this.getBuildings(villager)) {
            if (this.isDestPossible(villager, dest)) {
                // TODO: Implement getCraftingPos in ResManager
    ...
    public ItemStack getIcon() {
        // TODO: Access icon field in Goal or handle properly
        /*
         * if (this.icon != null) {
         * return this.icon.getItemStack();
         * } else {
         * return !this.output.isEmpty() ?
         * this.output.keySet().iterator().next().getItemStack() : null;
         * }
         */
    ...
    public boolean isDestPossibleSpecific(MillVillager villager, Building b) {
        for (InvItem item : this.input.keySet()) {
            // TODO: Implement countInv, countGoods
            /*
    ...
    public boolean performAction(MillVillager villager) throws Exception {
        ...
        if (dest == null) {
            ...
            if (this.sound != null) {
                // WorldUtilities.playSoundByMillName(villager.getLevel(), villager.getPos(),
                // this.sound, 1.0F);
            }
