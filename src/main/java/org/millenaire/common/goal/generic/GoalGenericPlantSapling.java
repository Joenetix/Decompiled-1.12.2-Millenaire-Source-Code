...
public class GoalGenericPlantSapling extends GoalGeneric {
   ...
   public ItemStack getIcon() {
      return this.icon != null ? this.icon.getItemStack() : InvItem.createInvItem(Blocks.SAPLING).getItemStack();
   }
   ...
   public boolean performAction(MillVillager villager) {
      ...
      if (block == Blocks.AIR
         ...
         if ("pinespawn".equals(saplingType)) {
            saplingBS = Blocks.SAPLING.getDefaultState().withProperty(BlockSapling.TYPE, EnumType.SPRUCE);
         } else if ("birchspawn".equals(saplingType)) {
            saplingBS = Blocks.SAPLING.getDefaultState().withProperty(BlockSapling.TYPE, EnumType.BIRCH);
         } else if ("junglespawn".equals(saplingType)) {
            saplingBS = Blocks.SAPLING.getDefaultState().withProperty(BlockSapling.TYPE, EnumType.JUNGLE);
         } else if ("acaciaspawn".equals(saplingType)) {
            saplingBS = Blocks.SAPLING.getDefaultState().withProperty(BlockSapling.TYPE, EnumType.ACACIA);
         } else if ("darkoakspawn".equals(saplingType)) {
            saplingBS = Blocks.SAPLING.getDefaultState().withProperty(BlockSapling.TYPE, EnumType.DARK_OAK);
