...
public class PathNavigateSimple extends PathNavigate {
   ...
   protected void pathFollow() {
      ...
      this.maxDistanceToWaypoint = this.entity.width > 0.75F
         ? this.entity.width / 2.0F
         : 0.75F - this.entity.width / 2.0F;
      Vec3d vec3d1 = this.currentPath.getCurrentPos();
      if (MathHelper.abs((float)(this.entity.posX - (vec3d1.x + 0.5))) < this.maxDistanceToWaypoint
         && MathHelper.abs((float)(this.entity.posZ - (vec3d1.z + 0.5))) < this.maxDistanceToWaypoint
         && Math.abs(this.entity.posY - vec3d1.y) < 1.0) {
