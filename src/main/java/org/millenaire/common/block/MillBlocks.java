...
public class MillBlocks {
   ...
   public static void initBlockStates() {
      BS_WET_BRICK = WET_BRICK.getDefaultState().withProperty(BlockWetBrick.PROGRESS, BlockWetBrick.EnumType.WETBRICK0);
      BS_MUD_BRICK = STONE_DECORATION.getDefaultState().withProperty(BlockDecorativeStone.VARIANT, BlockDecorativeStone.EnumType.MUDBRICK);
   }

   public static void registerBlocks(Register<Block> event) {
      Block decorativeWood = new BlockDecorativeWood("wood_deco");
      event.getRegistry().register(decorativeWood);
      Block decorativeStone = new BlockDecorativeStone("stone_deco");
      event.getRegistry().register(decorativeStone);
      event.getRegistry().register(new BlockDecorativeEarth("earth_deco"));
      event.getRegistry().register(new BlockMillWall("wall_mud_brick", decorativeStone));
      ...
      for (EnumDyeColor colour : EnumDyeColor.values()) {
         ...
         Block paintedBrickStairs = new BlockPaintedStairs("stairs_painted_brick", paintedBrick.getDefaultState(), colour);
         event.getRegistry().register(paintedBrickStairs);
      ...
      event.getRegistry()
         .register(
            new BlockMillStairs(
               "stairs_cookedbrick", decorativeStone.getDefaultState().withProperty(BlockDecorativeStone.VARIANT, BlockDecorativeStone.EnumType.COOKEDBRICK)
            )
         );
      event.getRegistry()
         .register(
            new BlockMillStairs(
               "stairs_mudbrick", decorativeStone.getDefaultState().withProperty(BlockDecorativeStone.VARIANT, BlockDecorativeStone.EnumType.MUDBRICK)
            )
         );
      event.getRegistry()
         .register(
            new BlockMillStairs(
               "stairs_timberframe", decorativeWood.getDefaultState().withProperty(BlockDecorativeWood.VARIANT, BlockDecorativeWood.EnumType.TIMBERFRAMEPLAIN)
            )
         );
      event.getRegistry()
         .register(
            new BlockMillStairs("stairs_thatch", decorativeWood.getDefaultState().withProperty(BlockDecorativeWood.VARIANT, BlockDecorativeWood.EnumType.THATCH))
         );
      ...
      event.getRegistry()
         .register(
            new BlockFruitLeaves(
               "leaves_appletree",
               BlockMillSapling.EnumMillWoodType.APPLETREE,
               new ResourceLocation("millenaire", "sapling_appletree"),
               new ResourceLocation("millenaire", "ciderapple")
            )
         );
      ...
      event.getRegistry()
         .register(
            new BlockFruitLeaves(
               "leaves_olivetree",
               BlockMillSapling.EnumMillWoodType.OLIVETREE,
               new ResourceLocation("millenaire", "sapling_olivetree"),
               new ResourceLocation("millenaire", "olives")
            )
         );
      ...
      event.getRegistry()
         .register(
            new BlockFruitLeaves(
               "leaves_pistachio",
               BlockMillSapling.EnumMillWoodType.PISTACHIO,
               new ResourceLocation("millenaire", "sapling_pistachio"),
               new ResourceLocation("millenaire", "pistachios")
            )
         );
      ...
      event.getRegistry()
         .register(
            new BlockFruitLeaves(
               "cherry_leaves",
               BlockMillSapling.EnumMillWoodType.CHERRY,
               new ResourceLocation("millenaire", "sapling_cherry"),
               new ResourceLocation("millenaire", "cherries")
            )
         );
      ...
      event.getRegistry()
         .register(
            new BlockFruitLeaves(
               "sakura_leaves",
               BlockMillSapling.EnumMillWoodType.SAKURA,
               new ResourceLocation("millenaire", "sapling_sakura"),
               new ResourceLocation("millenaire", "cherry_blossom")
            )
         );
      ...
      villageBannerWall.setTranslationKey("millenaire.villagebannerwall");
      villageBannerWall.setRegistryName("villagebannerwall");
      event.getRegistry().register(villageBannerWall);
      ...
      villageBannerStanding.setTranslationKey("millenaire.villagebannerstanding");
      villageBannerStanding.setRegistryName("villagebannerstanding");
      event.getRegistry().register(villageBannerStanding);
      ...
      cultureBannerWall.setTranslationKey("millenaire.culturebannerwall");
      cultureBannerWall.setRegistryName("culturebannerwall");
      event.getRegistry().register(cultureBannerWall);
      ...
      cultureBannerStanding.setTranslationKey("millenaire.culturebannerstanding");
      cultureBannerStanding.setRegistryName("culturebannerstanding");
      event.getRegistry().register(cultureBannerStanding);
   ...
   public static void registerItemBlockModels() {
      ...
      ModelLoader.setCustomModelResourceLocation(
         Item.getItemFromBlock(VILLAGE_BANNER_STANDING), 0, new ModelResourceLocation(VILLAGE_BANNER_STANDING.getRegistryName(), "inventory")
      );
      ModelLoader.setCustomModelResourceLocation(
         Item.getItemFromBlock(CULTURE_BANNER_STANDING), 0, new ModelResourceLocation(CULTURE_BANNER_STANDING.getRegistryName(), "inventory")
      );
   ...
   public static void registerItemBlocks(Register<Item> event) {
      event.getRegistry().register(new ItemBlockMeta(WOOD_DECORATION).setRegistryName(WOOD_DECORATION.getRegistryName()));
      event.getRegistry().register(new ItemBlockMeta(STONE_DECORATION).setRegistryName(STONE_DECORATION.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlockMeta(EXTENDED_MUD_BRICK).setRegistryName(EXTENDED_MUD_BRICK.getRegistryName()));
      event.getRegistry()
         .register(new ItemSlab(SLAB_WOOD_DECORATION, SLAB_WOOD_DECORATION, WOOD_DECORATION).setRegistryName(SLAB_WOOD_DECORATION.getRegistryName()));
      event.getRegistry()
         .register(new ItemSlab(SLAB_STONE_DECORATION, SLAB_STONE_DECORATION, STONE_DECORATION).setRegistryName(SLAB_STONE_DECORATION.getRegistryName()));
      event.getRegistry().register(new ItemBlockMeta(STAINED_GLASS).setRegistryName(STAINED_GLASS.getRegistryName()));
      event.getRegistry().register(new ItemBlock(ROSETTE).setRegistryName(ROSETTE.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_MUDBRICK).setRegistryName(STAIRS_MUDBRICK.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_TIMBERFRAME).setRegistryName(STAIRS_TIMBERFRAME.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_THATCH).setRegistryName(STAIRS_THATCH.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_BYZ_TILES).setRegistryName(STAIRS_BYZ_TILES.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlock(STAIRS_SANDSTONE_CARVED).setRegistryName(STAIRS_SANDSTONE_CARVED.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_SANDSTONE_RED_CARVED).setRegistryName(STAIRS_SANDSTONE_RED_CARVED.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_SANDSTONE_OCHRE_CARVED).setRegistryName(STAIRS_SANDSTONE_OCHRE_CARVED.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlock(PAPER_WALL).setRegistryName(PAPER_WALL.getRegistryName()));
      event.getRegistry().register(new ItemBlock(WOODEN_BARS).setRegistryName(WOODEN_BARS.getRegistryName()));
      event.getRegistry().register(new ItemBlock(WOODEN_BARS_INDIAN).setRegistryName(WOODEN_BARS_INDIAN.getRegistryName()));
      event.getRegistry().register(new ItemBlock(WOODEN_BARS_ROSETTE).setRegistryName(WOODEN_BARS_ROSETTE.getRegistryName()));
      event.getRegistry().register(new ItemBlock(LOCKED_CHEST).setRegistryName(LOCKED_CHEST.getRegistryName()));
      event.getRegistry().register(new ItemBlock(BYZANTINE_STONE_TILES).setRegistryName(BYZANTINE_STONE_TILES.getRegistryName()));
      event.getRegistry().register(new ItemBlock(BYZANTINE_SANDSTONE_TILES).setRegistryName(BYZANTINE_SANDSTONE_TILES.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlock(BYZANTINE_TILES).setRegistryName(BYZANTINE_TILES.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlock(SNOW_BRICK).setRegistryName(SNOW_BRICK.getRegistryName()));
      event.getRegistry().register(new ItemBlock(INUIT_CARVING).setRegistryName(INUIT_CARVING.getRegistryName()));
      event.getRegistry().register(new ItemBlock(SNOW_WALL).setRegistryName(SNOW_WALL.getRegistryName()));
      event.getRegistry().register(new ItemMillBed(BED_STRAW).setRegistryName(BED_STRAW.getRegistryName()));
      event.getRegistry().register(new ItemMillBed(BED_CHARPOY).setRegistryName(BED_CHARPOY.getRegistryName()));
      event.getRegistry().register(new ItemBlock(IMPORT_TABLE).setRegistryName(IMPORT_TABLE.getRegistryName()));
      event.getRegistry().register(new ItemMillSapling(SAPLING_APPLETREE, "sapling_appletree").setRegistryName(SAPLING_APPLETREE.getRegistryName()));
      event.getRegistry().register(new ItemBlock(LEAVES_APPLETREE).setRegistryName(LEAVES_APPLETREE.getRegistryName()));
      event.getRegistry().register(new ItemMillSapling(SAPLING_OLIVETREE, "sapling_olivetree").setRegistryName(SAPLING_OLIVETREE.getRegistryName()));
      event.getRegistry().register(new ItemBlock(LEAVES_OLIVETREE).setRegistryName(LEAVES_OLIVETREE.getRegistryName()));
      event.getRegistry().register(new ItemMillSapling(SAPLING_PISTACHIO, "sapling_pistachio").setRegistryName(SAPLING_PISTACHIO.getRegistryName()));
      event.getRegistry().register(new ItemBlock(LEAVES_PISTACHIO).setRegistryName(LEAVES_PISTACHIO.getRegistryName()));
      event.getRegistry().register(new ItemBlockMeta(MARKER_BLOCK).setRegistryName(MARKER_BLOCK.getRegistryName()));
      event.getRegistry().register(new ItemBlock(MAIN_CHEST).setRegistryName(MAIN_CHEST.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlock(FIRE_PIT).setRegistryName(FIRE_PIT.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_GRAY_TILES).setRegistryName(STAIRS_GRAY_TILES.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_GREEN_TILES).setRegistryName(STAIRS_GREEN_TILES.getRegistryName()));
      event.getRegistry().register(new ItemBlock(STAIRS_RED_TILES).setRegistryName(STAIRS_RED_TILES.getRegistryName()));
      event.getRegistry().register(new ItemBlock(GRAY_TILES).setRegistryName(GRAY_TILES.getRegistryName()));
      event.getRegistry().register(new ItemBlock(GREEN_TILES).setRegistryName(GREEN_TILES.getRegistryName()));
      event.getRegistry().register(new ItemBlock(RED_TILES).setRegistryName(RED_TILES.getRegistryName()));
      ...
      event.getRegistry().register(new ItemBlock(WOODEN_BARS_DARK).setRegistryName(WOODEN_BARS_DARK.getRegistryName()));
      event.getRegistry().register(new ItemMillSapling(SAPLING_CHERRY, "sapling_cherry").setRegistryName(SAPLING_CHERRY.getRegistryName()));
      event.getRegistry().register(new ItemBlock(CHERRY_LEAVES).setRegistryName(CHERRY_LEAVES.getRegistryName()));
      event.getRegistry().register(new ItemMillSapling(SAPLING_SAKURA, "sapling_sakura").setRegistryName(SAPLING_SAKURA.getRegistryName()));
      event.getRegistry().register(new ItemBlock(SAKURA_LEAVES).setRegistryName(SAKURA_LEAVES.getRegistryName()));
   }
